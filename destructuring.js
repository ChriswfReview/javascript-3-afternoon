...
{
  return obj.second
} else if (obj.first > obj.third){
  return obj.third
}else if (obj.third > obj.first){
  return obj.first
}
...
function numberGroups(obj){
  if (obj.a.length < obj.b.length)
  {
    return obj.b
  } else if (obj.a.length < obj.c.length){
    return obj.c
  }else if (obj.c.length < obj.a.length){
    return obj.a
  }
